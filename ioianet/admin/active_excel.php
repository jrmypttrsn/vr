...
$export = $db->get_results("SELECT status, CONCAT(firstname,' ',middle,' ',lname) AS Name,

	bus_name AS Business, address1, address2, city, state_code, zip, country, hphone AS home,

	cphone AS cell, wphone AS work, fax, email
...
header("Content-Disposition: attachment; filename=active_inspectors.xls");
